...
<p>O código é a representação do famoso jogo tic-tac-toe (jogo da velha), exercício proposto durante a formação FullStack JavaScript da OneBitCode.</p>
...
<ul>
  ...
  <li>Opção de reiniciar o jogo</li>
</ul>
